...
/**
 * Provides mock LLM responses for development and testing
 */
class MockLlmProvider {
    fun generateResponse(agent: Agent, messageHistory: List<Message>, promptOverride: String?): String {
        return when {
            promptOverride != null -> generateResponseBasedOnOverride(agent, promptOverride, messageHistory)
    ...
    private fun generateResponseBasedOnOverride(agent: Agent, promptOverride: String, recentMessages: List<Message>): String {
        // For summary prompt
